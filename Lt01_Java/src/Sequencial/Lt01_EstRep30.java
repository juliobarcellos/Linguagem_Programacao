...
public class Lt01_EstRep30 {
    ...
    {
       int AnoN=0, AnoA=0, MesN=0, MesA=0, DiaN=0, DiaA=0, NDiaN=0, NDiaA=0, AnoT=0, MesT=0, DiaT=0;
       String Idade="Idade: ";
       Calendar cal = Calendar.getInstance();
       
       AnoA = cal.get(Calendar.YEAR); MesA= (cal.get(Calendar.MONTH)+1); DiaA= cal.get(Calendar.DAY_OF_MONTH);
