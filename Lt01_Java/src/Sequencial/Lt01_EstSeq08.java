...
public class Lt01_EstSeq08
{
	...
	public static void main(String args [])
    {
        ...
        /* "%" diz que a próx variavel receberá o formato escolhido por você, ".2" diz a quantidade de casas decimais e o f é de float
        pode ser também s de String ou d de inteiro*/
    }
}