...
public class LT01_VT03 {
	...
	public static void main (String args[]){
		...
		for (Cont=0; Cont<=2;Cont++){
			VT1[Cont]= Integer.parseInt(JOptionPane.showInputDialog("Digite um número para a posição "+(Cont+1)+" do primeiro vetor: "));
			VT2[Cont]= Integer.parseInt(JOptionPane.showInputDialog("Digite um número para a posição "+(Cont+1)+" do segundo vetor: "));
		}
