...
public class Metodos {
	...
	void MostrarIndicadores() throws IOException {
		...
		do {
			Opc2=Integer.parseInt(JOptionPane.showInputDialog("Estatisticas de Votação 2019\n1 – Quantidade de eleitores por Seção\n2 –Seção com Maior e Menor número de Eleitores\n3 – Quantidade de votos por candidato\n4 – 10 Primeiros Colocados\n9 – Finaliza consulta"));
			switch (Opc2) {
			case 1:
				String Exibir="";
			...
			case 2:
				...
				JOptionPane.showMessageDialog(null, "Seção com menor número de votos: "+Min+"\nQuantidade de eleitores na seção: "+Vtsecao[Min]+"\n\nSeção com o maior número de eleitores: "+Max+"\nQuantidade de eleitores na seção: "+Vtsecao[Max]);
				break;
			case 3:
				for (Cont=0; Cont<31; Cont++) {
			...
			case 4:
				...
				for (Cont=0; Cont<10; Cont++) {
					Cand10+=("Candidato na posição "+(Cont+1)+"= "+ClasCand[Cont]+", com a quantidade de "+VtCand[ClasCand[Cont]]+" votos\n");
				}
