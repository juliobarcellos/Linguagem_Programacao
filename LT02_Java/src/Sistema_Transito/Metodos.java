...
public class Metodos {
		  ...
		  for (Cont = 0 ; Cont < 15 ; Cont++)
		   {
			  ...
			  estatistica[Cont].Cod_Cidade = (r.nextInt(5));//Integer.parseInt(JOptionPane.showInputDialog("Entre o código da cidade:"));	
			  ...
			  estatistica[Cont].Tipo_Veiculo = (r.nextInt(5-1)+1);//Integer.parseInt(JOptionPane.showInputDialog("Entre o tipo do veículo:"));
			  if ((Min==0)&&(Max==0)) {
	...
	void PTIPO (Estatistica[] estatistica) {
		...
		do Opc=Integer.parseInt(JOptionPane.showInputDialog("Pesquisa de acidentes por tipo de veículo:\n\nDigite o tipo de veículo desejado na pesquisa:\n1-Onibus\n2-Carros\n3-Motos\n4-Caminhões"));
		while ((Opc<1)||(Opc>4));
		for (Cont = 0 ; Cont < 15 ; Cont++) {
